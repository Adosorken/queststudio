...
namespace QuestStudio.Tree_Extensions
{
    public class TreeLE : TreeView
    {
        ...
        protected override void OnAfterLabelEdit(NodeLabelEditEventArgs e)
        {
            ...
            ValidateLabelEditEventArgs ea = new ValidateLabelEditEventArgs(e.Label, e.Node);
    ...
    public class ValidateLabelEditEventArgs : CancelEventArgs
    {
        ...
        public ValidateLabelEditEventArgs(string label, TreeNode node)
        {
            this.Node = node;
            this.Label = label;
            this.Cancel = false;
